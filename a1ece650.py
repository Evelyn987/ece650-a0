    ...
    while True:
        ...
        if entry != 'g':
            ...
            for w in range(len(list_eagle) - 1, -1, -1):
                for z in range(len(list_v2) - 1, -1, -1):
                    if (min(list_eagle[w][0][0], list_eagle[w][1][0]) < list_v2[z][0] < max(list_eagle[w][0][0],list_eagle[w][1][0])) and (
                             min(list_eagle[w][0][1], list_eagle[w][1][1]) < list_v2[z][1] < max(list_eagle[w][0][1],list_eagle[w][1][1])):
                        del list_eagle[w]
                    if(list_eagle[w] == (((3.64, 5.82), (0.0, 0.0)))):
                        list_eagle.append(list_eagle[w])
